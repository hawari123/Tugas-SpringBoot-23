package id.sinaukoding.latihan.config;
...
public class SwaggerConfig {
    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("id.sinaukoding.latihan.controller"))
                .build()
                .apiInfo(apiInfo());
    }
    ...
    private ApiInfo apiInfo(){
        return new ApiInfo(
                ...
                "1.0",
                "",
                new Contact("Burhanudin Hawari", "", "burhanudinhawari621211@gmail.com"),
                "",
                "",
                new ArrayList<>()
        );
